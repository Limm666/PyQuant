...
def EmailService(Subject):
    ...
    message = MIMEText(Subject.msg, 'plain', 'utf-8')

    message['Subject'] = Header(Subject.subject, 'utf-8')
    message['From'] = Header(Subject.sender, 'utf-8')
    message['To'] = Header(Subject.recevier, 'utf-8')
